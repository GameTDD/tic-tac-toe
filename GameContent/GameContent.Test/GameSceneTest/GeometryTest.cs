...
namespace GameContent.Test
{
	...
	public class GeometryTest
	{
		...
		{
			var auxMouse = new MouseState(100, 60, 0, ButtonState.Pressed, ButtonState.Released,
											 ButtonState.Released, ButtonState.Released, ButtonState.Released);
		...
		{
			var auxMouse = new MouseState(45, 100, 0, ButtonState.Pressed, ButtonState.Released,
									 ButtonState.Released, ButtonState.Released, ButtonState.Released);
			Assert.That(Regions.GeometricFunctions.IsInReagion(auxMouse.Position, rect), Is.False);
		}
		...
		{ 
			var prevState = new MouseState(120,120, 0, ButtonState.Released, ButtonState.Released,
											 ButtonState.Released, ButtonState.Released, ButtonState.Released);
